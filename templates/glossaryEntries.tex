...
\newglossaryentry{Angular-4-Candy}{
    ...
    description={Bei Angular 4 handelt es sich um ein TypeScript-basiertes Front-End-Webanwendungsframework. Bei dem Angular-4-Candy handelt es sich um eine JSweet Bibliothek welche es erlaubt Angular Anwendungen aus Java in Typescript/Javascript zu übersetzen.}
}
