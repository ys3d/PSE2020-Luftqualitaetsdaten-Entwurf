...
namespace de.visaq.controller {
     ...
     */
    export class LocationController extends de.visaq.controller.SensorthingsController<de.visaq.model.sensorthings.Location> {
        public getAll() : Array<de.visaq.model.sensorthings.Location> {
            return null;
        }

        public get$java_lang_String(id : string) : de.visaq.model.sensorthings.Location {
            return null;
        }
         ...
         */
        public singleBuild(json : org.json.JSONObject) : de.visaq.model.sensorthings.Location {
            json = de.visaq.controller.UtilityController.removeArrayWrapper(json);
            let location : de.visaq.model.sensorthings.Location = new de.visaq.model.sensorthings.Location(json.getString("@iot.id"), json.getString("@iot.selfLink"), json.getString("name"), json.getString("description"), de.visaq.controller.UtilityController.buildLocationPoint(json), <any>(new de.visaq.controller.link.MultiOnlineLink<de.visaq.model.sensorthings.HistoricalLocation>(json.getString("HistoricalLocations@iot.navigationLink"))), <any>(new de.visaq.controller.link.MultiOnlineLink<de.visaq.model.sensorthings.Thing>(json.getString("Things@iot.navigationLink"))));
            return location;
        }
    }
