...
public class GenericTest {
	...
	public void testSingleObservedPropertyGet() {
		SingleOnlineLink<ObservedProperty> sol = new SingleOnlineLink<ObservedProperty>("/ObservedProperties?$top=1");
		sol.get(new ObservedPropertyController());
		sol.get(new ObservedPropertyController());
	}
	@Test
	public void testSingleObservationGet() {
		SingleOnlineLink<Observation> sol = new SingleOnlineLink<Observation>("/Observations?$top=1&$skip=1");
	...
	public void testSingleHistoricalLocationGet() {
		SingleOnlineLink<HistoricalLocation> sol = new SingleOnlineLink<HistoricalLocation>("/HistoricalLocations?$top=1");
	...
	public void testMultiObservedPropertyGet() {
		MultiOnlineLink<ObservedProperty> mol = new MultiOnlineLink<ObservedProperty>("/ObservedProperties?$top=2");
	...
	public void testMultiHistoricalLocationGet() {
		MultiOnlineLink<HistoricalLocation> mol = new MultiOnlineLink<HistoricalLocation>("/HistoricalLocations?$top=2");
