...
public class DatastreamController extends SensorthingsController<Datastream> {
	...
	public Datastream singleBuild(JSONObject json) {
		...
		Datastream datastream = new Datastream(json.getString("@iot.id"), json.getString("@iot.selfLink"),
				json.getString("name"), json.getString("description"), json.getJSONObject("properties").toMap(),
