 ...
 */
public abstract class Sensorthings<sensorthing extends Sensorthings<sensorthing>> {
	 ...
	 */
	public final SingleLocalLink<sensorthing> selfLink;
	...
	public Sensorthings(String id, String selfUrl) {
		this.id = id;
		this.selfLink = new SingleLocalLink<sensorthing>(selfUrl, this);
	}
